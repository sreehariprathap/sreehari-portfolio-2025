            ...
            <div className="p-10 relative z-10 overflow-visible">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    { name: "Software Development", icon: <Code size={16} />, color: "from-violet-500 to-purple-500", bgLight: "bg-violet-100", textLight: "text-violet-800", bgDark: "dark:bg-violet-900/30", textDark: "dark:text-violet-300", intensity: "high" },
                    { name: "UI/UX Design", icon: <Paintbrush size={16} />, color: "from-pink-500 to-rose-500", bgLight: "bg-pink-100", textLight: "text-pink-800", bgDark: "dark:bg-pink-900/30", textDark: "dark:text-pink-300", intensity: "high" },
                    { name: "Software Testing", icon: <FlaskConical size={16} />, color: "from-amber-500 to-orange-500", bgLight: "bg-amber-100", textLight: "text-amber-800", bgDark: "dark:bg-amber-900/30", textDark: "dark:text-amber-300", intensity: "medium" },
                    { name: "Cloud", icon: <Cloud size={16} />, color: "from-cyan-500 to-blue-500", bgLight: "bg-cyan-100", textLight: "text-cyan-800", bgDark: "dark:bg-cyan-900/30", textDark: "dark:text-cyan-300", intensity: "medium" },
                    { name: "Finance", icon: <ChartBarIncreasing size={16} />, color: "from-emerald-500 to-green-500", bgLight: "bg-emerald-100", textLight: "text-emerald-800", bgDark: "dark:bg-emerald-900/30", textDark: "dark:text-emerald-300", intensity: "low" }
                  ].map((expertise, i) => (
                    <div 
                      key={i} 
                    ...
                    >
                      <div className="relative z-10 flex items-center gap-1.5">
                        <span className={`${expertise.textLight} ${expertise.textDark} group-hover:text-white dark:group-hover:text-white transition-all duration-500`}>
                          {expertise.icon}
                        </span>
                        <span className={`text-sm font-medium group-hover:text-white dark:group-hover:text-white transition-all duration-500`}>
                          {expertise.name}
                      ...
                      {/* Gradient background with enhanced fade animation */}
                      <span className={`absolute inset-0 bg-gradient-to-r ${expertise.color} opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out transform origin-left group-hover:scale-x-100 scale-x-0`}></span>
                      {/* Dark mode background with enhanced fade */}
                      <span className="absolute inset-0 bg-black opacity-0 dark:opacity-100 group-hover:opacity-0 transition-all duration-500 ease-in-out"></span>
                    </div>
                  ))}
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  { name: "Movies", icon: <FilmIcon size={16} />, color: "from-red-500 to-pink-500", bgLight: "bg-red-100", textLight: "text-red-800", bgDark: "dark:bg-red-900/30", textDark: "dark:text-red-300", intensity: "high" },
                  { name: "Cooking", icon: <CookieIcon size={16} />, color: "from-amber-500 to-yellow-500", bgLight: "bg-amber-100", textLight: "text-amber-800", bgDark: "dark:bg-amber-900/30", textDark: "dark:text-amber-300", intensity: "high" },
                  { name: "Gym", icon: <Dumbbell size={16} />, color: "from-indigo-500 to-blue-500", bgLight: "bg-indigo-100", textLight: "text-indigo-800", bgDark: "dark:bg-indigo-900/30", textDark: "dark:text-indigo-300", intensity: "medium" },
                  { name: "Cycling", icon: <Bike size={16} />, color: "from-teal-500 to-cyan-500", bgLight: "bg-teal-100", textLight: "text-teal-800", bgDark: "dark:bg-teal-900/30", textDark: "dark:text-teal-300", intensity: "medium" },
                  { name: "Reading", icon: <Book size={16} />, color: "from-purple-500 to-violet-500", bgLight: "bg-purple-100", textLight: "text-purple-800", bgDark: "dark:bg-purple-900/30", textDark: "dark:text-purple-300", intensity: "low" }
                ].map((hobby, i) => (
                  <div key={i} className={`group relative px-3 py-1 ${hobby.bgLight} ${hobby.bgDark} rounded-full overflow-hidden ${hobby.textLight} ${hobby.textDark} transition-all duration-300 hover:shadow-md dark:shadow-md`}>
                    <div className="relative z-10 flex items-center gap-1.5">
                      <span className={`${hobby.textLight} ${hobby.textDark} group-hover:text-white dark:group-hover:text-white transition-all duration-500`}>
                        {hobby.icon}
                      </span>
                      <span className={`text-sm font-medium group-hover:text-white dark:group-hover:text-white transition-all duration-500`}>
                        {hobby.name}
                    ...
                    {/* Enhanced gradient background with subtle fade animation */}
                    <span className={`absolute inset-0 bg-gradient-to-r ${hobby.color} opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out transform origin-left group-hover:scale-x-100 scale-x-0`}></span>
                    {/* Dark mode background with enhanced fade */}
                    <span className="absolute inset-0 bg-black opacity-0 dark:opacity-100 group-hover:opacity-0 transition-all duration-500 ease-in-out"></span>
                  </div>
                ))}
